...
namespace OdrCop3
{
    ...
    public:
        ...
        std::string Serialize() const
        {
            ...
            { // the "unspeciailized" template parameters
            ...
            out += IndentBlock(CXXRecordDeclSerializer<SerializeDecl, SerializeType, SerializeAttr>(contextItems, static_cast<const clang::CXXRecordDecl*>(classTemplatePartialSpecializationDecl)).Serialize(), 0);
