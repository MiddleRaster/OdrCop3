...
namespace OdrCop3
{
    namespace Serialize
    {
        ...
        static inline std::string CallSerializer(const ContextItems& contextItems, const clang::Decl* decl)
        {
            ...
            case clang::Decl::Kind::ClassTemplateSpecialization:        if (const ClassTemplateSpecializationDecl*         ctsd = dyn_cast<       ClassTemplateSpecializationDecl>(decl)) return        ClassTemplateSpecializationDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,               ctsd).Serialize(); break;
            ...
            case clang::Decl::Kind::Function:                           if (const FunctionDecl*                    functionDecl = dyn_cast<                          FunctionDecl>(decl)) return                           FunctionDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,       functionDecl).Serialize(); break;
            case clang::Decl::Kind::CXXConversion:                      if (const CXXConversionDecl*          cxxConversionDecl = dyn_cast<                     CXXConversionDecl>(decl)) return                      CXXConversionDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,  cxxConversionDecl).Serialize(); break;
            ...
            case clang::Decl::Kind::ParmVar:                            if (const ParmVarDecl *                             pvd = dyn_cast<                           ParmVarDecl>(decl)) return                            ParmVarDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,                pvd).Serialize(); break;
            case clang::Decl::Kind::CXXRecord:                          if (const CXXRecordDecl *                 cxxRecordDecl = dyn_cast<                         CXXRecordDecl>(decl)) return                          CXXRecordDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,      cxxRecordDecl).Serialize(); break;
            case clang::Decl::Kind::Field:                              if (const FieldDecl *                         fieldDecl = dyn_cast<                             FieldDecl>(decl)) return                              FieldDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,          fieldDecl).Serialize(); break;
            ...
            case clang::Decl::Kind::Var:                                if (const VarDecl *                             varDecl = dyn_cast<                               VarDecl>(decl)) return                                VarDeclSerializer<SerializeDecl, SerializeType, SerializeExpr>(contextItems,            varDecl).Serialize(); break;
        ...
        inline std::string Decls(const ContextItems& contextItems, const clang::Decl* decl)
        {
            ...
            if (serializationNeeds.AreAllFalse() == true)
                return Print::Decl(contextItems, decl);
            return CallSerializer<&Decls<SerializeType, SerializeExpr>, SerializeType, SerializeExpr>(contextItems.withSerializationNeeds(serializationNeeds), decl);
        }
    }
}