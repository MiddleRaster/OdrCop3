...
namespace OdrCop3
{
    ...
    inline bool NeedsManualSerialization(const ContextItems& contextItems, const clang::Attr                 *                  attr) { return NeedsManualSerialization(contextItems, [&](llvm::raw_ostream& os, const clang::PrintingPolicy& policy) {                  attr->printPretty(os,                       policy); }); }
