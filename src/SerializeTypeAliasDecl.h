...
namespace OdrCop3
{
    ...
    public:
        ...
        std::string Serialize() const
        {
            ...
            fqtd += IndentBlock(SerializeType(contextItems, contextItems.serializationNeeds.hasNamespaceAlias ? typeAliasDecl->getUnderlyingType().getCanonicalType() : typeAliasDecl->getUnderlyingType()), fqtd.size());
